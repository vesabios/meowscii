...
public class PlayerInputFrame : InputFrame {

    Vector2 moveVector = Vector2.zero;
    Vector2 cursorMoveVector = Vector2.zero;
    
    public static PlayerInputFrame instance;
    ...
    {
        cursorMoveVector = QuantizeStickInput(inputState.rightStick);
    }

    public override void OnLeftStick(InputState inputState)
    {
        moveVector = QuantizeStickInput(inputState.leftStick);
    }

    public override void OnDpad(InputState inputState)
    {
        moveVector = inputState.dpad;
    }
